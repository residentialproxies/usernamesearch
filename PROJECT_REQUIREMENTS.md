...
─ / (Homepage)  展示 top的一些网站 （你帮我决定）

├─ /pricing -> 简洁的定价页。
├─Resource
         ├─ 支持的网站全列表 (/supported-sites) 展示全部支持的网站  /whatsmyname/lib/data.json
...
## /pricing
用充值的方式，$10 美金的固定价格 request 500次 
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-8">
                    <a href="/" class="flex-shrink-0 flex items-center space-x-2">
                         <svg class="w-8 h-8 text-sky-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5">
                            <path d="M25 25 L20 20"></path>
                            <circle cx="13" cy="13" r="8"></circle>
                            <circle cx="13" cy="11" r="3" stroke-width="2"></circle>
                            <path d="M9, 18 C9, 15.5, 17, 15.5, 17, 18" stroke-width="2"></path>
                        </svg>
                        <span class="font-bold text-xl text-slate-800 dark:text-white">usernamesearch.io</span>
                    </a>
                    <div class="hidden md:flex items-center space-x-6">
                        <a href="/pricing" class="flex items-center text-sm font-semibold text-slate-600 dark:text-slate-300 hover:text-sky-500 dark:hover:text-sky-400 transition">
                        ...
                        <div class="relative group">
                            <button class="flex items-center text-sm font-semibold text-slate-600 dark:text-slate-300 hover:text-sky-500 dark:hover:text-sky-400 transition">
                                <svg class="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25"></path></svg>
                                <span>Resources</span>
                                <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                            </button>
                            <div class="absolute top-full mt-2 w-48 bg-white dark:bg-slate-800 rounded-lg shadow-lg border dark:border-slate-700 hidden group-hover:block py-2">
                                <a href="/supported-sites" class="flex items-center px-4 py-2 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700">Supported Sites</a>
                                <a href="/guides" class="flex items-center px-4 py-2 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700">Guides</a>
                                <a href="/tools" class="flex items-center px-4 py-2 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700">Tools</a>
                            </div>
                        </div>

                        <a href="/api" class="flex items-center text-sm font-semibold text-slate-600 dark:text-slate-300 hover:text-sky-500 dark:hover:text-sky-400 transition">
                            <svg class="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5"></path></svg>
                            <span>API</span>
                        </a>

                        <!-- NEW NAME: AI Username Generator -->
                        <button id="ai-generator-btn" class="flex items-center text-sm font-semibold text-slate-600 dark:text-slate-300 hover:text-sky-500 dark:hover:text-sky-400 transition">
                ...
                <div class="hidden md:flex items-center space-x-4">
                    <div id="logged-out-view" class="flex items-center space-x-4">
                        <a href="/auth/login" class="text-sm font-semibold text-slate-600 dark:text-slate-300 hover:text-sky-500 dark:hover:text-sky-400 transition">Log In</a>
                        <a href="/auth/signup" class="text-sm font-semibold text-white bg-sky-500 hover:bg-sky-600 px-4 py-2 rounded-lg transition">Sign Up</a>
                    </div>
                </div>

                <div class="md:hidden flex items-center">
                    <button id="mobile-menu-button" class="inline-flex items-center justify-center p-2 rounded-md text-slate-500">
...
<footer class="bg-white dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700">
        <div class="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <!-- Column 1: Product -->
                <div>
                    <h3 class="text-sm font-semibold text-slate-500 dark:text-slate-400 tracking-wider uppercase">Product</h3>
                    <ul class="mt-4 space-y-4">
                        <li><a href="/" class="text-base text-slate-600 dark:text-slate-300 hover:text-sky-500 transition">Home</a></li>
                        <li><a href="/pricing" class="text-base text-slate-600 dark:text-slate-300 hover:text-sky-500 transition">Pricing</a></li>
                        <li><a href="/api" class="text-base text-slate-600 dark:text-slate-300 hover:text-sky-500 transition">API</a></li>
                    </ul>
                </div>
                
                <!-- Column 2: Resources -->
                <div>
                    <h3 class="text-sm font-semibold text-slate-500 dark:text-slate-400 tracking-wider uppercase">Resources</h3>
                    <ul class="mt-4 space-y-4">
                        <li><a href="/tools" class="text-base text-slate-600 dark:text-slate-300 hover:text-sky-500 transition">Tools</a></li>
                        <li><a href="/guides" class="text-base text-slate-600 dark:text-slate-300 hover:text-sky-500 transition">Guides</a></li>
                        <li><a href="/api/docs" class="text-base text-slate-600 dark:text-slate-300 hover:text-sky-500 transition">Documentation</a></li>
                    </ul>
                </div>

                <!-- Column 3: Company & Legal -->
                <div>
                    <h3 class="text-sm font-semibold text-slate-500 dark:text-slate-400 tracking-wider uppercase">Company</h3>
                    <ul class="mt-4 space-y-4">
                        <li><a href="/contact" class="text-base text-slate-600 dark:text-slate-300 hover:text-sky-500 transition">Contact</a></li>
                        <li><a href="/privacy" class="text-base text-slate-600 dark:text-slate-300 hover:text-sky-500 transition">Privacy Policy</a></li>
                        <li><a href="/terms" class="text-base text-slate-600 dark:text-slate-300 hover:text-sky-500 transition">Terms of Service</a></li>
                    </ul>
                </div>
                
            </div>
            <div class="mt-8 pt-8 border-t border-slate-200 dark:border-slate-700 md:flex md:items-center md:justify-between">
                ...
                <div class="mt-8 md:mt-0 md:order-1">
                    <p class="text-center text-base text-slate-500 dark:text-slate-400">© 2025 usernamesearch.io. All rights reserved.</p>
                </div>
            </div>
        </div>
    </footer>
...
展示top 的几百个后者更少的网站。兼顾用户体验 和 free的功能
...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>Instant Username Search Across 400+ Sites | usernamesearch.io</title>
    <meta name="description" content="The most comprehensive username checker. Instantly see if your name is available on Instagram, TikTok, Twitter, GitHub, and hundreds more. Free to start!">
    <meta name="keywords" content="username search, username checker, handle checker, social media name check, domain search">
...
<body class="bg-slate-100 dark:bg-slate-900 text-slate-800 dark:text-slate-200 antialiased">
    ...
    <main class="container mx-auto px-4 py-8 md:py-12">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center space-x-3">
                <svg class="w-12 h-12 text-sky-500" xmlns="http://www.w.w3.org/2000/svg" viewBox="0 0 32 32" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5">
                ...
                <div>
                    <h1 class="text-4xl md:text-5xl font-extrabold text-slate-900 dark:text-white tracking-tight">Username Search</h1>
                    <p class="text-sm font-semibold text-slate-500 dark:text-slate-400">on usernamesearch.io</p>
                </div>
            </div>
            <p class="mt-4 max-w-2xl mx-auto text-lg text-slate-600 dark:text-slate-400">Instantly check your username across 400+ social networks and platforms.</p>
        </div>
        ...
        <div class="sticky top-4 bg-slate-100/80 dark:bg-slate-900/80 backdrop-blur-md p-4 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 z-10">
            <div class="flex items-center space-x-2">
                <div class="relative flex-grow">
                    ...
                    <input type="text" id="username-input" placeholder="Enter username to check instantly..." class="w-full pl-12 pr-4 py-3 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500 transition text-lg">
                </div>
        ...
        <div id="results-container" class="mt-6 space-y-4">
            <div id="placeholder" class="col-span-full text-center py-24">
                ...
                <p class="text-lg font-semibold text-slate-600 dark:text-slate-300">Ready to claim your digital identity?</p>
                <p class="mt-1">Enter a username above to check its availability across our free network of 100+ sites.</p>
            </div>
        </div>
    </main>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const siteData = [
            { name: 'Instagram', category: 'Social Networks', tier: 'Free' }, { name: 'TikTok', category: 'Social Networks', tier: 'Free' }, { name: 'X (Twitter)', category: 'Social Networks', tier: 'Free' }, { name: 'Facebook', category: 'Social Networks', tier: 'Free' }, { name: 'Reddit', category: 'Social Networks', tier: 'Free' }, { name: 'Threads', category: 'Social Networks', tier: 'Free' }, { name: 'LinkedIn', category: 'Social Networks', tier: 'Free' }, { name: 'Pinterest', category: 'Social Networks', tier: 'Free' }, { name: 'Snapchat', category: 'Social Networks', tier: 'Free' }, { name: 'Telegram', category: 'Social Networks', tier: 'Free' }, { name: 'Bluesky', category: 'Social Networks', tier: 'Free' }, { name: 'Discord', category: 'Social Networks', tier: 'Free' },
            { name: 'YouTube', category: 'Video & Streaming', tier: 'Free' }, { name: 'Twitch', category: 'Video & Streaming', tier: 'Free' }, { name: 'Vimeo', category: 'Video & Streaming', tier: 'Free' },
            { name: 'Behance', category: 'Design & Art', tier: 'Free' }, { name: 'Dribbble', category: 'Design & Art', tier: 'Free' },
            { name: 'GitHub', category: 'Software & Development', tier: 'Free' }, { name: 'GitLab', category: 'Software & Development', tier: 'Free' }, { name: 'Stack Overflow', category: 'Software & Development', tier: 'Free' },
            { name: 'Steam (User)', category: 'Gaming', tier: 'Free' }, { name: 'Roblox', category: 'Gaming', tier: 'Free' },
            { name: 'Flickr', category: 'Social Networks', tier: 'Pro' }, { name: '500px', category: 'Design & Art', tier: 'Pro' }, { name: 'HackerNews', category: 'Professional & Business', tier: 'Pro' }
        ];
        ...
        const FREE_QUOTA = 15;
        let userQuota = { count: 0, lastReset: new Date().getDate() }; 

        const debounce = (func, delay) => { let timeoutId; return (...args) => { clearTimeout(timeoutId); timeoutId = setTimeout(() => { func.apply(this, args); }, delay); }; };

        const startSearch = async (isRefresh = false) => {
            ...
            const cachedResult = getFromCache(username);
            if (cachedResult && !isRefresh) {
                ui.statusBar.innerHTML = `Last Checked: ${formatTimestamp(cachedResult.timestamp)}. Cached views are free. <button id="refresh-btn" class="ml-2 font-semibold text-sky-500 hover:underline">Refresh Live Results</button>`;
                document.getElementById('refresh-btn').onclick = () => startSearch(true);
                renderCategorizedResults(cachedResult.data);
            ...
            if (isQuotaExceeded()) {
                 ui.statusBar.innerHTML = `You've used your ${FREE_QUOTA} free real-time searches for today. <a href="/pricing" class="font-semibold text-sky-500 hover:underline">Upgrade to Pro</a> for more.`;
                 renderCategorizedResults([]); // Render empty state with Pro placeholders
                 searchIsRunning = false;
                 ui.searchBtn.disabled = false;
                 return;
            }
            
            if (isRefresh) consumeQuota();

            const sitesToCheck = siteData.filter(s => s.tier === 'Free');
            ui.statusBar.innerHTML = `Checking availability for "${username}"...`;
            const results = await Promise.all(sitesToCheck.map(site => mockApiCheck(site, username)));
            
            if (!isRefresh) consumeQuota();
            saveToCache(username, results);
            
            renderCategorizedResults(results);
            ui.statusBar.innerHTML = `Live results for "${username}". You have ${FREE_QUOTA - userQuota.count} real-time searches left today.`;
            searchIsRunning = false;
            ui.searchBtn.disabled = false;
        };
        ...
        const renderCategorizedResults = (results) => {
            ...
            const resultsMap = new Map(results.map(r => [r.name, r.status]));
            ...
            categoryOrder.forEach(category => {
                ...
                categorySites.forEach(site => {
                    const status = resultsMap.get(site.name) || (site.tier === 'Pro' ? 'Pro' : 'Unknown');
                    gridContent += createCardHTML(site, status);
                });
            ...
            // Add the Pro upsell card
            const upsellCard = document.createElement('div');
            upsellCard.innerHTML = `
                <div class="bg-sky-50 dark:bg-sky-900/50 border-2 border-dashed border-sky-300 dark:border-sky-700 rounded-lg p-6 text-center">
                    <h3 class="font-bold text-slate-800 dark:text-white">Want to check all 400+ sites?</h3>
                    <p class="mt-2 text-sm text-slate-600 dark:text-slate-400">Upgrade to Pro to unlock hundreds of niche, professional, and international platforms.</p>
                    <a href="/pricing" class="mt-4 inline-block text-sm font-semibold text-white bg-sky-500 hover:bg-sky-600 px-4 py-2 rounded-lg transition">Learn More about Pro</a>
                </div>
            `;
            ui.resultsContainer.appendChild(upsellCard);
        };

        const createCardHTML = (site, status) => {
            let statusHTML = '';
             switch(status) {
                case 'Available': statusHTML = `<span class="font-semibold text-green-500">Available</span>`; break;
                case 'Taken': statusHTML = `<span class="font-semibold text-red-500">Taken</span>`; break;
                case 'Pro': statusHTML = `<a href="/pricing" class="font-semibold text-yellow-500 hover:underline">Pro</a>`; break;
                default: statusHTML = `<span class="font-semibold text-slate-400">Unknown</span>`;
            }
            // In a real app, you'd have an icon mapping. Here we just show the name.
            return `<div class="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg flex items-center justify-between">
                        <div class="flex items-center space-x-3"><span class="font-semibold text-slate-700 dark:text-slate-200">${site.name}</span></div>
        ...
        const mockApiCheck = async (site, username) => {
            return new Promise(resolve => {
                setTimeout(() => {
                    ...
                    let status = rand < 0.6 ? 'Taken' : (rand < 0.95 ? 'Available' : 'Unknown');
                    resolve({ ...site, status });
                }, 500 + Math.random() * 1000);
            });
        };
        
        const getFromCache = (username) => JSON.parse(localStorage.getItem('usernameCache') || '{}')[username];
        const saveToCache = (username, data) => {
            const cache = JSON.parse(localStorage.getItem('usernameCache') || '{}');
            cache[username] = { timestamp: new Date().toISOString(), data: data };
        ...
        const isQuotaExceeded = () => {
             ...
             if (userQuota.lastReset !== today) { userQuota = { count: 0, lastReset: today }; }
             return userQuota.count >= FREE_QUOTA;
        };
        const consumeQuota = () => { userQuota.count++; };
        const formatTimestamp = (isoString) => {
            return new Date(isoString).toLocaleString('en-US', { month: 'short', day: 'numeric', year: 'numeric', hour: 'numeric', minute: 'numeric', second: 'numeric', hour12: true, timeZoneName: 'short' }).replace(' at ', ' ');
        };
        ...
        ui.searchBtn.addEventListener('click', () => startSearch(false));
        ui.usernameInput.addEventListener('keydown', e => { if (e.key === 'Enter') { e.preventDefault(); startSearch(false); }});
    });
    </script>
</body>
</html>
